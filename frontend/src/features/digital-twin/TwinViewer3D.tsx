import { resolveTwinFidelityFromCode } from "./damBarrageTwinRegistry";
...
function sourceBacked(twin: TwinResponse): boolean {
  ...
  return (
    resolveTwinFidelityFromCode(twin.asset.asset_code, twin.twin.fidelity_level) !== "L0" &&
  ...
  return (
    <div className="twin-canvas">
      ...
      <div className="viewer-label">
        <strong>{resolveTwinFidelityFromCode(twin.asset.asset_code, twin.twin.fidelity_level)}</strong>

        <span>
          {twin.twin.uri
            ? "Measured/published model Ã‚Â· check provenance"
            : backed
              ? "Source-driven asset-specific parametric twin Ã‚Â· dimensions shown from linked records"
              : "Illustrative type twin Ã‚Â· dimensions are not claimed as measured"}
        </span>
      </div>
