...
function transformAsset(backendAsset: BackendAsset): any {
  return {
    ...
    asset_type: backendAsset.type, // Map backend 'type' to frontend 'asset_type'
    location: backendAsset.location,
    district: backendAsset.district,
    // Convert string coordinates to numbers
    lat: backendAsset.latitude ? Number(backendAsset.latitude) : undefined,
    lng: backendAsset.longitude ? Number(backendAsset.longitude) : undefined,
    latitude: backendAsset.latitude ? Number(backendAsset.latitude) : undefined,
    longitude: backendAsset.longitude ? Number(backendAsset.longitude) : undefined,
    built_year: backendAsset.built_year || backendAsset.age,
    ...
    remaining_useful_life: backendAsset.remaining_useful_life || backendAsset.design_life,
