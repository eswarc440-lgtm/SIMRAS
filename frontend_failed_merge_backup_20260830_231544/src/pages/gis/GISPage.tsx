        ...
        const transformedAssets = geojson.features
          .map((feature) => {
            ...
            return {
              ...
              builtYear: Number(props.built_year ?? props.age ?? 2000),
              rulYears: Number(props.remaining_useful_life ?? 10),
        ...
        try {
          ...
          const transformedAssets = result.data
            .map((asset) => ({
              ...
              rulYears: Number(asset.remaining_useful_life ?? 10),
            ...
            <div className="h-[52vh] min-h-[380px] lg:h-[calc(100vh-16rem)]">
              {mounted && !loading ? (
                ...
                <div className="grid size-full place-items-center text-sm text-muted-foreground">
                  {loading ? "Loading real asset data from database…" : "Preparing GIS workspace…"}
                </div>
              )}
            </div>
                ...
                <div className="mt-3 space-y-3">
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-muted-foreground">
                      {selected.condition} · {selected.type} · {selected.location}
                    </p>
                  </div>
