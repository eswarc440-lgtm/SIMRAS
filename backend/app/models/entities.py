...
# ============================================================
# Government / authoritative source documents
# ============================================================
...
class SourceDocument(Base, TimestampMixin):
    ...
    raw_uri: Mapped[str | None] = mapped_column(
        Text,
    )
...
# ============================================================
# Normalised government / official evidence
# ============================================================


class OfficialEvidence(Base, TimestampMixin):
    ...
    rating_system: Mapped[str | None] = mapped_column(
        String(100),
        index=True,
    )
