...
class AssetSummary(BaseModel):
    ...
    twin_quality_score: int = 0
    twin_quality: str = "BASIC"
    twin_group: str = "BASIC"
    twin_quality_label: str = "No active source-backed model"
    twin_fidelity: str = "L0"
    twin_source_backed: bool = False
    twin_dimension_count: int = 0
    twin_template: str = "generic"
...
class PredictionState(BaseModel):
    ...
    operational_risk_level: str | None = None
    operational_confidence: float | None = None
    operational_method: str | None = None
